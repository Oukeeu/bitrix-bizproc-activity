<?php
define('C_REST_CLIENT_ID','local.64454b67baaeb4.59748301');//Application ID
define('C_REST_CLIENT_SECRET','nEEN9iujTzUoqSAGwHdeQk02CZYjBfpV18HtcKBKZKTmWGf7Yv');//Application key
// or
