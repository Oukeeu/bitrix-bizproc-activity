...
$Botresult = CRest::call(
    ...
    [
        ...
        'PROPERTIES' => [ // Bot personality (req.)
            'NAME' => 'BizzActivity',// Bot name (NAME or LAST_NAME is required)
            ...
            'WORK_POSITION' => 'BizzProc',// Bot 'job-title' as a bot description
            'PERSONAL_WWW' => '',
...
$result = CRest::call('bizproc.activity.delete', ['CODE' => 'md5']);
    ...
    [
        ...
        'ID' =>
            [
                ...
                'Description' =>
                    [
                        'ru' => 'Введите ID чата (Можно ввести несолько через запятую, MAX - 10).',
                        'en' => 'Enter the chat ID (You can enter more than one, separated by commas, MAX - 10).'
                    ],
                'Type' => 'string',
                'Required' => 'Y',
                'Multiple' => 'N',
